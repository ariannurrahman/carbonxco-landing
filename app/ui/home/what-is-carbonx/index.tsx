      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 py-[100px]'>
        <div className='flex justify-center items-start flex-col flex-nowrap'>
          ...
          <p className='text-[16px] text-black font-medium mt-[29px] mb-[43px]'>
            ...
            solutions. So, we are eager to embrace our journey in enabling a just transition to a low-carbon and
            resilient development. In the midst of all the uncertainties, we would like to invite you to help amplify
            the values of carbon initiatives, as well as to celebrate how diverse our struggles, experiences, and
            identities are within our communities.
          </p>
