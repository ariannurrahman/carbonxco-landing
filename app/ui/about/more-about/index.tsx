    ...
    <div className='relative w-screen h-[500px]'>
      <div className='z-20 relative  flex justify-center items-center flex-col w-full h-full'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 mt-10'>
          <div className='cursor-pointer bg-[#D4EFDE4D] border-2 border-[#D4EFDE] p-14 flex-1 w-[300px] lg:w-[400px] h-[150px] rounded-lg flex items-center'>
          ...
          <div className='cursor-pointer bg-[#E9DB5D80] border-2 border-[#FFC42D] p-14 flex-1 w-[300px] lg:w-[400px] h-[150px] rounded-lg flex items-center'>
