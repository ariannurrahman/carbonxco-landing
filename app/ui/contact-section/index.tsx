...
export const ContactSection = () => {
  return (
    <>
      <SectionWrapper className='grid grid-cols-1 md:grid-cols-[500px_auto] py-20' padding='high'>
        <div className='flex justify-center items-center'>
          <Image src='/assets/home/contact.png' className='object-fit' width={500} height={500} alt='contact' />
        </div>
        <div className='flex flex-col justify-center'>
          <h2 className='text-[32px] font-medium'>Have a carbon project in mind?</h2>
        ...
        <div className='z-20 relative  flex justify-center items-center flex-col w-full h-full'>
          <div className='max-w-[538px]'>
            ...
            <p className='text-base text-white text-center mt-5'>
              Call <span className='text-[#46A7ED]'>+6221 1234 5678</span> or e-mail us at{' '}
              <span className='text-[#46A7ED] underline'>hello@carbonx.com</span>
            </p>
          </div>
